...
public class FindServersClient {
    ...
    */
    ...
    public CompletableFuture<Void> outputFindServersOnNetwork(String discoveryEndpointUrl) {
    ...
    public CompletableFuture<ServerOnNetwork[]> findServersOnNetwork(String discoveryEndpointUrl) {
    ...
    public CompletableFuture<Void> outputFindServers(String discoveryEndpointUrl) {
        CompletableFuture<Void> finished = new CompletableFuture<>();
    ...
    public CompletableFuture<Void> outputGetEndpoints(ApplicationDescription applicationDescription) {
        CompletableFuture<Void> finished = new CompletableFuture<>();
